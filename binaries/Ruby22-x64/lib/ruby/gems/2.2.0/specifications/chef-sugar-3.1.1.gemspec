# -*- encoding: utf-8 -*-
# stub: chef-sugar 3.1.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<test-kitchen>, ["~> 1.3"])
      s.add_development_dependency(%q<kitchen-vagrant>, ["~> 0.15"])
    else
      s.add_dependency(%q<bundler>, ["~> 1.3"])
      s.add_dependency(%q<rake>, [">= 0"])
      s.add_dependency(%q<chefspec>, ["~> 4.2"])
      s.add_dependency(%q<test-kitchen>, ["~> 1.3"])
      s.add_dependency(%q<kitchen-vagrant>, ["~> 0.15"])
    end
  else
    s.add_dependency(%q<bundler>, ["~> 1.3"])
    s.add_dependency(%q<rake>, [">= 0"])
